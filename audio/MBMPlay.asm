...
-:  ld (hl), a
    ...
    sub 2                           ; (we've got to go back to the tick *before* the last one)
...
MBMPlayDrum:
    ...
    ld a, $20                       ; clear all rhythm instruments to set up trigger for next write
    ld c, $0E
    call FMOut
...
-:  exx
    ...
    exx                             ; revert to original set of register pairs
